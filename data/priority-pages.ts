...
export const priorityPages: Record<PriorityPageKey, Page> = {
  ...
  satellite: {
    ...
    metaDescription: 'Compare satellite broadband options in the UK, including real Starlink prices, equipment costs, latency, data policies and alternatives for rural homes and businesses.',
    ...
    quickAnswer: 'Starlink is the dominant satellite broadband option for UK consumers, from £40 a month for a 100Mbps residential plan up to £80 for its fastest Max tier, plus a one-off dish and router kit from around £299 to £449. Satellite is most compelling where usable full fibre, fixed wireless and 4G/5G are unavailable. Check equipment ownership, installation, data policy, latency, power use and cancellation terms before committing.',
    updated: '2026-08-24', schemaType: 'Article', breadcrumbs: guideCrumbs('Satellite broadband UK', '/guides/satellite-broadband-uk'),
    table: { title: 'Starlink UK residential plans, August 2026', headers: ['Plan', 'Speed', 'Monthly price', 'Data'], rows: [
      ['Residential 100Mbps', 'Capped at 100Mbps', '£40/mo', 'Unlimited'],
      ['Residential 200Mbps', 'Capped at 200Mbps', '£60/mo', 'Unlimited'],
      ['Residential Max', 'Up to 400+Mbps', '£80/mo', 'Unlimited'],
      ['Roam (portable)', 'Variable', '£55/mo (100GB) or £100/mo (unlimited)', '100GB or unlimited'],
    ]},
    sections: [
      { heading: 'Starlink is the dominant option, and its lineup just changed', paragraphs: ['Starlink remains the only widely available consumer satellite broadband service in the UK with genuinely useful speeds, typically 120 to 300Mbps download in real-world use with latency around 25ms, low enough for video calls and most online gaming. Its Global Roam plan, aimed at international travel use, stopped accepting new customers on 15 July 2026 and was withdrawn entirely for existing customers on 17 August 2026; anyone who relied on it has had to migrate to a standard Roam plan or a business Priority plan, which the provider itself does not describe as an identical replacement.', 'The Standard Kit, a dish, Wi-Fi router, ground-level base and cables, costs £449, though it is commonly discounted to around £299 on entry and mid-tier residential plans, and offered free with a minimum-term commitment on the Residential Max plan. A £10 a month equipment fee applies on some newer residential rental orders, so check whether a specific offer is a purchase or a rental before comparing the true monthly cost. Professional installation, if needed, typically costs £225 to £350 plus VAT on top.'] },
      { heading: 'What affects satellite performance', paragraphs: ['The dish needs a clear, largely unobstructed view of the sky. Trees, buildings, heavy weather, network congestion at peak times and handovers between satellites can all affect consistency. Low-Earth-orbit systems like Starlink have latency far lower than older geostationary satellite services, typically 25 to 60ms against 600ms or more, but results still vary by location, time of day and weather.'] },
      { heading: 'Alternatives to Starlink', paragraphs: ['A handful of smaller providers exist for households that specifically want an alternative to Starlink: SkyDSL offers up to 50Mbps from roughly £35 to £50 a month on more flexible contract terms, and Bigblu Broadband offers hybrid satellite and terrestrial plans at 30 to 100Mbps. Eutelsat, which now owns OneWeb, runs a separate low-Earth-orbit constellation, but OneWeb does not sell consumer home broadband plans; its service is aimed at businesses, governments and the maritime and aviation sectors. For most UK households, Starlink remains the only satellite option with genuinely competitive speeds.'] },
      { heading: 'Costs to compare', paragraphs: ['Add the hardware cost or rental fee, any delivery and mounting charge, professional installation if used, and the monthly service price across a realistic period, since satellite equipment is a much larger upfront cost than a typical fixed-line router. Check whether a priority-data allowance applies on portable Roam plans and what happens to speed after it is used, and always confirm a current price directly with the provider rather than relying on an old quoted figure.'] },
      { heading: 'Who should consider satellite broadband', paragraphs: ['Rural homes with poor copper speeds and no realistic fibre timeline, farms, temporary sites, and anyone needing a physically independent backup connection are the clearest genuine use cases. Before committing, check the UK Gigabit Broadband Voucher Scheme, which can subsidise the cost of extending a fixed fibre connection to an eligible rural property, sometimes making full fibre more cost-effective than satellite once installation is included. For ordinary homes where FTTP is already available, fixed fibre is almost always simpler, cheaper and more consistent than satellite.'] },
    ],
    faqs: [
      { question: 'How much does Starlink cost in the UK?', answer: 'Starlink\'s UK residential plans run from £40 a month for a 100Mbps-capped tier, £60 for 200Mbps, up to £80 for its fastest Residential Max plan with unlimited data on every tier. A one-off Standard Kit (dish, router and cables) costs £449, though it is commonly discounted to around £299 on entry and mid-tier plans, and offered free with a minimum-term commitment on the Max plan.' },
      { question: 'Is satellite broadband available everywhere in the UK?', answer: 'Starlink\'s coverage is broad across the UK, but a suitable installation location with a clear, largely unobstructed view of the sky is still required, and speeds and consistency vary by location, weather and network congestion.' },
      { question: 'What happened to Starlink\'s Global Roam plan?', answer: 'Starlink stopped accepting new Global Roam customers on 15 July 2026 and withdrew the plan entirely for existing customers on 17 August 2026. Affected customers have had to migrate to a standard Roam plan (from £55 a month for 100GB) or a business Priority plan, neither of which Starlink describes as an identical replacement.' },
      { question: 'Is satellite broadband good for gaming?', answer: 'Low-Earth-orbit satellite like Starlink, with latency typically around 25ms, can support most online games reasonably well, though brief interruptions and variability are more likely than on a fixed fibre connection.' },
      { question: 'Should I choose satellite instead of 5G home broadband?', answer: 'Test mobile signal at the property first. Where 5G coverage is genuinely strong, it is usually cheaper and simpler than satellite; satellite is most valuable specifically where terrestrial mobile and fixed options are weak or unavailable.' },
    ],
    sources: [
      { label: 'Ofcom Connected Nations', href: 'https://www.ofcom.org.uk/phones-and-broadband/coverage-and-speeds/connected-nations' },
      { label: 'Starlink UK service plans', href: 'https://www.starlink.com/gb/residential', verified: '2026-08-24' },
      { label: 'UK Gigabit Broadband Voucher Scheme', href: 'https://gigabitvoucher.culture.gov.uk/' },
    ],
  },
  london: {
  ...
  sheffield: {
    path: '/postcode/sheffield', title: 'Broadband providers in Sheffield: coverage and deals', metaTitle: 'Broadband Providers Sheffield: Coverage & Deals 2026',
    metaDescription: 'Compare broadband providers in Sheffield by network, speed and total contract cost. Check Openreach, Virgin Media, CityFibre and local full fibre.',
    eyebrow: 'Sheffield broadband hub', dek: 'Sheffield has genuine network choice, but the provider list and fastest orderable speed can change between neighbouring homes. Start with the complete address.',
    quickAnswer: 'Broadband providers in Sheffield include BT, EE, Plusnet, Sky, TalkTalk, Vodafone and Zen over Openreach, plus Virgin Media and retailers using CityFibre where their networks reach the property. Pine Media also serves selected Sheffield addresses. Openreach reported around 215,000 local properties reached in April 2025, but no citywide provider is best for every home, so check the full address before comparing cost and speed.',
    updated: '2026-09-01', schemaType: 'CollectionPage', breadcrumbs: [{ name: 'Home', href: '/' }, { name: 'Broadband by postcode', href: '/postcode' }, { name: 'Sheffield', href: '/postcode/sheffield' }],
    table: { title: 'Main broadband routes to check in Sheffield', headers: ['Network/route', 'Provider choice', 'What to verify'], rows: [
      ...
      ['Pine Media and other local networks', 'Pine Media builds its own Sheffield network and also sells an Openreach-based service', 'Which network supplies the package, installation status, upload speed and price-lock terms'],
    ]},
    sections: [
      { heading: 'Which broadband providers cover Sheffield?', paragraphs: ['Sheffield broadband arrives over several physical networks. Openreach carries services from retailers including BT, EE, Plusnet, Sky, TalkTalk, Vodafone and Zen. Virgin Media runs a separate network. CityFibre is a wholesale full-fibre network whose available retail partners are shown after an address check. Pine Media builds its own local network and also sells a separate service using Openreach, so confirm which connection a quoted package uses.', 'Openreach said on 3 April 2025 that its Full Fibre build reached around 215,000 properties in and around Sheffield, more than three quarters of homes and businesses in the Sheffield City Council area. That is an Openreach footprint figure, not proof that every Sheffield address can order FTTP and not a measure of CityFibre, Virgin Media or Pine Media coverage.'] },
      { heading: 'How to find the best broadband deals in Sheffield', paragraphs: ['Check the complete house or flat address on every network that may cover it. Compare only packages confirmed as orderable, then write down the advertised average download and upload speeds, personalised estimate, minimum guarantee, setup charge, contract length and every scheduled price increase. Add those charges across the whole minimum term instead of choosing the lowest first-month price.', 'For most busy homes, an orderable 100 to 300 Mbps full-fibre plan is a sensible starting shortlist. Pay for 500 Mbps or gigabit service when several people regularly download large games, back up substantial files or stream at once. Upload-heavy work may favour a symmetric local or CityFibre-based service, but the retailer must confirm its upload tier and terms.'] },
      { heading: 'Full-fibre broadband in Sheffield', paragraphs: ['Full fibre, also called FTTP, uses fibre from the exchange or network to the property rather than copper for the final section. Openreach, CityFibre and Pine Media all require an address check before showing whether their respective full-fibre service is live. Virgin Media availability and the technology used also need property-level confirmation.', 'A network build passing a street does not always mean one flat or house is ready to order. Openreach explains that engineering routes, staged construction and landlord permissions can make availability differ within the same street. CityFibre similarly asks for a postcode and address before naming the retailers available on its network.'] },
      { heading: 'Sheffield city centre and S1 broadband checks', paragraphs: ['S1 includes the city centre and many flats, converted buildings and mixed-use premises. A citywide coverage percentage can hide building-specific access and internal cabling. Use our S1 broadband guide for the local provider shortlist, then check the flat number or complete business address with the network and retailer before arranging installation.', 'Students and renters should check the tenancy end date against the minimum term and ask whether landlord or building-manager permission is needed for new external cabling. A 24-month offer can cost more overall than a higher monthly rolling or shorter contract if an early-exit charge is likely.'] },
      { heading: 'What if fixed full fibre is not available?', paragraphs: ['Keep an orderable FTTC or cable package on the shortlist if it meets the household need, and check fixed wireless or 4G and 5G home broadband as alternatives. Mobile performance depends on indoor signal, congestion, router position and the network, so test coverage at the address and read any speed estimate or fair-use condition before replacing a fixed line.', 'Ofcom defines decent broadband as at least 10 Mbit/s download and 1 Mbit/s upload. Eligible homes that cannot receive that level from an affordable service can ask BT about the broadband Universal Service Obligation, although excess network-build costs and alternative wireless or satellite options can affect eligibility.'] },
      { heading: 'Why Sheffield coverage varies by address', paragraphs: ['Network builds progress street by street, while flats can depend on wayleaves, building access and internal cabling. An exchange area or outward postcode can therefore contain homes using copper, part-fibre, cable and FTTP connections. Openreach distinguishes service that is available now, coming soon and merely planned; only the first status is ready to order.', 'Use the Ofcom checker for an independent coverage indication, then verify the same complete address with the network and chosen retail provider. The provider result controls the package, installation date and personalised speed estimate. Recheck shortly before ordering because build status, retailers and offers change.'] },
    ],
    faqs: [
      ...
      { question: 'What is the fastest broadband available in Sheffield?', answer: 'Gigabit and faster packages are available at some Sheffield addresses, but the fastest orderable service depends on the network connected to the property and the retailer’s product range. Check Openreach, Virgin Media, CityFibre and relevant local networks with the complete address, then compare advertised average speed, upload speed and the personalised minimum guarantee rather than a citywide maximum.' },
      { question: 'Which broadband is suitable for Sheffield students and renters?', answer: 'Students and renters should first match the contract length to the tenancy, then check whether installation needs landlord or building-manager permission. Compare the total cost including setup, scheduled increases and possible early-exit charges. A lower speed or shorter contract can be better value than a discounted 24-month gigabit package if the household expects to move before the minimum term ends.' },
      { question: 'Can I compare Sheffield broadband without a postcode?', answer: 'You can compare networks, contract features and typical speed tiers without a postcode, but you cannot confirm an orderable Sheffield package from the city name alone. Networks may serve one building and miss the next. Enter the full postcode and select the exact address, then ask the retail provider to confirm installation, speed estimate, charges and contract terms before buying.' },
    ],
    sources: [
      { label: 'Ofcom Connected Nations Spring 2026 update', href: 'https://www.ofcom.org.uk/phones-and-broadband/coverage-and-speeds/connected-nations-update-spring-2026', verified: '2026-09-01' },
      { label: 'Ofcom broadband coverage checker', href: 'https://checker.ofcom.org.uk/en-gb/broadband-coverage', verified: '2026-09-01' },
      { label: 'GOV.UK broadband Universal Service Obligation', href: 'https://www.gov.uk/guidance/broadband-universal-service-obligation-uso', verified: '2026-09-01' },
      { label: 'Openreach: Full Fibre milestone for Sheffield', href: 'https://www.openreach.com/news/full-fibre-milestone-for-sheffield/', verified: '2026-09-01' },
      { label: 'Openreach fibre availability checker', href: 'https://www.openreach.com/fibre-checker', verified: '2026-09-01' },
      { label: 'Openreach full-fibre provider list', href: 'https://www.openreach.com/fibre-broadband/fttp-providers', verified: '2026-09-01' },
      { label: 'CityFibre home availability checker', href: 'https://cityfibre.com/homes', verified: '2026-09-01' },
      { label: 'Pine Media Sheffield full-fibre broadband', href: 'https://pinemedia.net/', verified: '2026-09-01' },
      { label: 'Broadband Genie Sheffield comparison', href: 'https://www.broadband.co.uk/broadband/in/sheffield', verified: '2026-09-01' },
    ],
  },
  edinburgh: {
...
function providerDeal(slug: string, provider: string, bestFor: string, caution: string, officialUrl: string): Page {
  ...
  return {
    path, title: `${provider} broadband deals`, metaTitle: `${provider} Broadband Deals UK ${currentMonthYear()}`,
