...
export const guides: GuideMetadata[] = [
  {
    ...
    excerpt: 'To switch broadband provider in the UK, choose an address-specific deal and order it from the new provider. Ofcom closed its One Touch Switch enforcement programme in June 2026, confirming it as the industry\'s permanent standard: the new provider normally coordinates the transfer and your old broadband ends only after the replacement service starts.',
    readingTime: 10,
    category: 'switching-and-rights',
    keyTakeaways: [
      'Contact the provider you are joining. Under One Touch Switch, now the industry\'s permanent standard after Ofcom closed its enforcement case in June 2026, it normally contacts your old provider and coordinates the transfer.',
    ...
    sources: [
      ...
      { label: 'findcheapbroadband.com: Ofcom closes One Touch Switch enforcement programme', href: 'https://findcheapbroadband.com/blog/ofcom-closes-one-touch-switch-enforcement-programme/' },
  ...
  },
  {
    ...
    metaDescription: 'Looking for broadband without surprise annual increases? Only Zen Internet and toob genuinely apply no scheduled rise; Hyperoptic and NOW Broadband are wrongly assumed to be no-rise options.',
    publishDate: '2026-06-21',
    updatedDate: '2026-08-25',
    excerpt: 'Being an altnet does not mean no price rise: Hyperoptic and NOW Broadband are both sometimes wrongly assumed to be no-rise options, but both apply a real scheduled increase. Only Zen Internet and toob genuinely have none.',
    readingTime: 9,
    category: 'deals-and-pricing',
    keyTakeaways: [
      'Only Zen Internet and toob genuinely apply no scheduled price rise at all; Hyperoptic (~£4/mo each April) and NOW Broadband (£3 scheduled for 2027 and 2028) are both sometimes wrongly assumed to be no-rise options.',
  ...
  },
  {
    ...
    metaDescription: 'Compare UK broadband and TV bundles from Sky, Virgin Media and EE TV with our interactive filterable tool. See the best options for sports, entertainment and flexible streaming.',
    publishDate: '2026-06-21',
  ...
  },
  {
    ...
    metaDescription: 'Compare UK broadband deals with cashback, reward cards and vouchers by full contract cost. Check current examples, claim rules and two offers side by side.',
    publishDate: '2026-06-21',
    updatedDate: '2026-08-29',
    excerpt: 'Broadband deals with cashback are worthwhile only when the reward makes a suitable package cheaper across its full minimum term. Current UK listings checked on 29 August 2026 showed provider rewards from £50 to £200, while BT cards ranged from £80 to £140. Add scheduled price rises and setup fees, then subtract only a reward you can claim and use.',
    readingTime: 10,
    category: 'deals-and-pricing',
    keyTakeaways: [
      'Current UK listings checked on 29 August 2026 showed selected provider rewards from £50 to £200, but values vary by package, address and purchase route.',
      'BT Reward Cards were independently listed at £80 to £140, alongside £30 setup and scheduled price rises that must remain in the contract-cost calculation.',
      'Treat cashback as a reduction in full minimum-term cost only after checking eligibility, claim, activation and spending deadlines.',
      'Compare every offer with and without the reward. A lower monthly price can beat a larger card when the full term is added up.',
    ],
    sources: [
      {
        label: 'BT: claim, activate and use a Reward Card',
        href: 'https://www.bt.com/help/account-and-billing/information-about-the-bt-reward-card',
      },
      { label: 'EE Reward Card terms and conditions', href: 'https://ee.co.uk/content/dam/help/terms-and-conditions/broadband/reward-card/Reward-Card-Terms-and-Conditions.pdf' },
      { label: 'Ofcom: telecoms price rises and consumer rights', href: 'https://www.ofcom.org.uk/phones-and-broadband/saving-money/telecoms-price-rises-what-are-your-rights' },
      { label: 'Broadband Genie: BT Reward Card offers', href: 'https://www.broadband.co.uk/providers/bt/broadband/reward-card' },
      { label: 'Finder: UK broadband cashback offers', href: 'https://www.finder.com/uk/broadband-plans' },
      { label: 'Broadbandchoices: cashback, rewards and gifts', href: 'https://www.broadbandchoices.co.uk/broadband/cashback' },
    ],
  },
  {
    ...
    metaDescription: 'Compare the best broadband deals with no setup fee in the UK. BT actually charges GBP30 (not free as often assumed), and NOW Broadband\'s GBP5 fee is credited back. Real current examples compared.',
    publishDate: '2026-06-21',
    updatedDate: '2026-08-25',
    excerpt: 'A no-setup-fee broadband deal can lower your upfront cost, but not every provider advertised as fee-free actually is. BT genuinely charges GBP30, and NOW Broadband\'s GBP5 "advance fee" is credited back rather than a real cost.',
    readingTime: 8,
    category: 'deals-and-pricing',
    keyTakeaways: [
      'BT charges a genuine £30 setup fee, offset only by a reward card that must be actively claimed; Virgin Media\'s £35 fee has no offset at all.',
      'NOW Broadband\'s £5 advance fee is credited back to the first bill, so it functions as genuinely free setup, a different structure from BT\'s reward card.',
      'Sky, EE, TalkTalk, Plusnet, Vodafone, Hyperoptic and Community Fibre all currently charge no setup fee at all.',
    ],
    sources: [
      {
        label: 'BroadbandPicker review methodology',
  ...
  },
  {
    ...
    metaDescription: 'Looking for student broadband in the UK? NOW Broadband and TalkTalk have both moved away from their old budget/flexible positioning. Real current options: YouFibre rolling monthly, Onestream, Hyperoptic and Community Fibre.',
    publishDate: '2026-06-21',
    updatedDate: '2026-08-25',
    excerpt: 'NOW Broadband and TalkTalk, long the default student broadband recommendations, have both moved away from the budget or flexible-contract positioning they were known for. Real current options for shared houses and short tenancies.',
    readingTime: 9,
    category: 'use-cases-and-lifestyle',
    keyTakeaways: [
      'NOW Broadband no longer offers flexible contracts, and TalkTalk is no longer the clearly low-cost option; both moved away from the positioning students often chose them for.',
      'YouFibre is one of the few providers offering a genuine rolling monthly contract, from £33.99 a month, worth it specifically for a short or uncertain tenancy.',
      'Match the minimum term to the tenancy so the household is not paying after moving out; a 12-month contract from Hyperoptic, Community Fibre or Onestream is often the better middle ground.',
    ],
    sources: [
      {
        label: 'BroadbandPicker review methodology',
